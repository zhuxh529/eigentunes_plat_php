...
(function($) {
    $.fn.player = function(settings) {
        ...
        this.each(function() {
            $(this).before('<div class="simple-player-container" style="background-color: #ddd; padding: 0 10px 5px 5px; height:18px;">');
            $(this).after('</div>');
            $(this).parent().find('.simple-player-container').prepend(
                '<div ><ul>' + 
                    ...
                    '<li class="progressbar-wrapper" style="margin-top:-5px;display: inline-block; cursor: pointer; width:' + config.progressbarWidth + ';">' + 
                        '<span style="bottom:-5px;display: block; background-color: ' + config.progressbarBGColor + '; width: 100%; ">' + 
                        '<span class="progressbar" style="display: block;margin-top:-5px; background-color: ' + config.progressbarColor +
